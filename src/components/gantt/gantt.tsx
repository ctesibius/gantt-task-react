...
const defaultDistances: Distances = {
  ...
  contextMenuOptionHeight: 20,
  contextMenuSidePadding: 8,
  dateCellWidth: 100,
  dependenciesCellWidth: 80,
  dependencyFixHeight: 16,
  dependencyFixIndent: 40,
  dependencyFixWidth: 16,
  expandIconWidth: 16,
  handleWidth: 6,
  headerHeight: 24,
  minimumRowDisplayed: 4,
  nestedTaskNameOffset: 16,
  relationCircleOffset: 8,
  relationCircleRadius: 4,
  rowHeight: 24,
  taskWarningOffset: 28,
  titleCellWidth: 200
};
